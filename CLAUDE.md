...
**Arrancar por:** ~~`numeros`~~ ✅ → ~~`sumas-con-llevada`~~ ✅ (4) → ~~`restas-con-llevada`~~ ✅ (4) → ~~`sumas-y-restas-mezcladas`~~ ✅ (4) → ~~`multiplicacion-concepto`~~ ✅ (6) → ~~`tablas-de-multiplicar`~~ ✅ (10) → **SIGUIENTE: `doble-y-mitad`** (cierra `operaciones` de 2º).
