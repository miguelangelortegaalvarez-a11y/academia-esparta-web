...
**Arrancar por:** ~~`numeros`~~ ✅ (21) → ~~`operaciones`~~ ✅ (33) → ~~`medida`~~ ✅ (19) → ~~`geometria`~~ ✅ (16) → ~~`estadistica`~~ ✅ (12) → **`problemas` (ÚLTIMO bloque de 2º). Sub-bloques acordados: problemas-suma-con-llevada · problemas-resta-con-prestar · problemas-multiplicacion · problemas-dos-operaciones · problemas-mixtos.**
