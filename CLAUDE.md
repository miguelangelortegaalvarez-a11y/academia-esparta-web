...
│   │   │                 # Bloque D Gramática 4/8 ✅: analisis-morfologico, verbos-irregulares, oracion-simple, campos-semanticos
│   │   │                 # Siguiente: 5º D connotacion-y-denotacion (4 sub-bloques restantes) ⬅
│   │   └── 6/            # Sin carpeta aún
│   └── 1-eso/
...
- **5º Primaria Lengua (Gramática · bloque D)** — 4/8 sub-bloques × 10 fichas = 40 fichas (2026-05-23). Sub-bloques cubiertos: analisis-morfologico, verbos-irregulares, oracion-simple, campos-semanticos. Pendientes: connotacion-y-denotacion, acentuacion-completa, tildes-diacriticas, puntuacion-avanzada.
- **1º ESO Matemáticas** — solo álgebra (4 páginas)
- **Total:** ~559 fichas indexadas en sitemap
...
1. **5º Primaria Lengua · Bloque D "Gramática y ortografía"** — 4/8 sub-bloques cubiertos (analisis-morfologico, verbos-irregulares, oracion-simple, campos-semanticos). **Siguiente sugerido:** `connotacion-y-denotacion` (significado literal vs. cargado de matiz, lenguaje figurado, sentido propio vs. figurado). Pendientes 4: connotacion-y-denotacion, acentuacion-completa, tildes-diacriticas, puntuacion-avanzada. **Patrón establecido:** 10 fichas por sub-bloque (no 6 como cursos anteriores), dificultad progresiva ⭐→⭐⭐⭐⭐, registrar en `materiales.html` como clave `'lengua|5|D|Nombre del sub-bloque'` antes del primer bloque LECTURA de 5º. Ruta: `recursos/primaria/5/lengua/BLOQUE/`.
