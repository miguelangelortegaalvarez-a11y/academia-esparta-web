...
**BLOQUE `operaciones` DE 3º COMPLETO ✅** (36 fichas: sumas-y-restas-llevando 6 + multiplicacion-por-una-cifra 6 + multiplicacion-por-dos-cifras 6 + propiedades-y-calculo-mental 6 + la-division-concepto-y-reparto 6 + division-por-una-cifra 6). **SIGUIENTE en 3º: bloque `medida`** (árbol: longitud-km-m-cm-mm · masa-kilo-gramo · capacidad-litro-mililitro · el-reloj-y-los-minutos · el-dinero-euros-y-centimos · superficie). Reusables de 2º para medida: regla SVG (33px=1cm), balanza, vaso con nivel, reloj analógico, SVG dinero.
