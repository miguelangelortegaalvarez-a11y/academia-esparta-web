...
| `geometria` 🟡 | figuras-planas (3 ✅) · cuerpos-geometricos · lineas-y-situacion-espacial | ~9-12 |
...
1. **1º Primaria Matemáticas** — estructura acordada con Miguel el 2026-05-24 (detalle completo en sección "Estructura matemáticas Primaria"). 6 bloques (5 LOMLOE + problemas), sub-bloques anidados, **6 fichas/serie**, curso a curso 1º→6º. **Total 1º Mates: 120 fichas**.
   ...
   - **Bloque `geometria` EN MARCHA — `figuras-planas` COMPLETO ✅** (3 fichas, cerrado 2026-05-28). Tercer sub-bloque con SVG inline (tras monedas y reloj). 4 figuras canónicas: triángulo, cuadrado, rectángulo, círculo. Plantilla SVG simple reusable (viewBox 0-60, stroke 2.5, fill none). ficha-1 Recuerda + 4 ejercicios (unir, contar lados, rodear triángulos, rodear círculos y cuadrados). ficha-2 contar en mosaico, asociar figura↔objeto (plato/puerta/ventana/tejado), continuar series, tachar intruso. ficha-3 contar figuras en un dibujo de casita SVG + dibujar libre + V/F + escribir nombre. **Norma nueva 2026-05-28:** uniones figura↔texto sin caja contenedora alrededor de la figura (Miguel pidió quitarla porque se veía vacía); las píldoras solo para el texto. Otro aprendizaje: dejar **~100-150px de aire** debajo del footer en el PDF para que al imprimir desde Safari no se vaya a 2 páginas (sus márgenes difieren del `@page` CSS).
   ...
   - **Siguiente: `cuerpos-geometricos`** (cubo, esfera, cilindro, cono — ~3 fichas) y luego `lineas-y-situacion-espacial` (recta/curva, abierto/cerrado, dentro/fuera, encima/debajo).
