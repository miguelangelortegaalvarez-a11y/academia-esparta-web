...
**Arrancar por:** ~~`numeros`~~ ✅ (21) → ~~`operaciones`~~ ✅ (33) → ~~`medida`~~ ✅ (19) → **`geometria` EN MARCHA**: ~~figuras-planas~~ ✅ (4) → ~~cuerpos-geometricos~~ ✅ (4) → **siguiente: `lineas-rectas-curvas-poligonales`** → simetria.
