...
**SIGUIENTE en 3º:** `las-fracciones` (sub-bloque 5 de numeros; luego sumar-y-restar-fracciones → cierra `numeros`). Nivel acordado: fracciones concepto + sumar/restar mismo denominador.
...
- **3º Primaria Matemáticas — EN MARCHA** (arrancado 2026-06-15, fuente Poppins):
  - `numeros`: `numeros-hasta-10000` (6) ✅ + `valor-posicional-y-descomposicion` (6) ✅ + `comparar-y-ordenar` (6) ✅ + `numeros-romanos` (6) ✅ — siguiente: `las-fracciones`
- **1º ESO Matemáticas** — solo álgebra (4 páginas)
- **Total:** ~963 fichas indexadas en sitemap
...
1. **1º Primaria Matemáticas COMPLETO ✅** (cerrado 2026-05-28, **71 fichas**) — estructura acordada con Miguel el 2026-05-24 (detalle completo en sección "Estructura matemáticas Primaria"). 6 bloques (5 LOMLOE + problemas), sub-bloques anidados. Cifra final aplicando la norma "ajustar fichas al material real" (en 1º muchos conceptos no dan para 6 fichas distintas).
   ...
   - **1º MATES COMPLETO ✅** (2026-05-28, 71 fichas). **2º MATES COMPLETO ✅** (2026-06-14, 131 fichas). **3º MATES EN MARCHA** (arrancado 2026-06-15): árbol acordado + `numeros-hasta-10000` ✅ (6) + `valor-posicional-y-descomposicion` ✅ (6) + `comparar-y-ordenar` ✅ (6) + `numeros-romanos` ✅ (6). **Siguiente:** continuar el bloque `numeros` de 3º por `las-fracciones` (ver sección "Sub-bloques 3º Primaria"). 3º usa **Poppins**.
