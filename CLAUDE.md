...
- **3º Primaria Matemáticas — EN MARCHA** (arrancado 2026-06-15, fuente Poppins):
  ...
  - **Bloque `medida` EN MARCHA**: `longitud-km-m-cm-mm` (6) ✅ (commit a9b1d39, cerrado 2026-06-22 — solo km/m/cm/mm, conversiones enteras sin decimales; f1 a mano + f2-f6 con 5 agentes/1 ficha; reusa regla SVG de 2º + `.problema`) + `masa-kilo-gramo` (6) ✅ (commit 9a2896e, cerrado 2026-06-23 — kg/g + ½ kg=500g/¼ kg=250g; reusa balanza SVG de 2º; ⚠️ quedó corta → PENDIENTE reajustar llenado) + `capacidad-litro-mililitro` (6) ✅ (cerrado 2026-06-23 — l/ml + ½ l=500ml/¼ l=250ml, conversiones enteras; f1 a mano + f2-f6 con 5 agentes/1 ficha; reusa vaso SVG con nivel de 2º + `.problema`; densificada al nuevo criterio de llenado 75-85%) — **siguiente sub-bloque: `el-reloj-y-los-minutos`** (reusar reloj SVG de 2º)
