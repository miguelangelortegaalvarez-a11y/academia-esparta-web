...
**Arrancar por:** ~~`numeros`~~ ✅ (21) → ~~`operaciones`~~ ✅ (33) → **`medida` EN MARCHA:** longitud-metro-centimetro ✅ (3) · peso-y-capacidad ✅ (4) · el-reloj-horas-y-media ✅ (4) · monedas-y-billetes ✅ (4) · _siguiente y último de medida_ **calendario**.
