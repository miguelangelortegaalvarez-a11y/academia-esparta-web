...
**Arrancar por:** ~~`numeros`~~ ✅ (21) → ~~`operaciones`~~ ✅ (33) → **`medida` EN MARCHA:** longitud-metro-centimetro ✅ (3) · peso-y-capacidad ✅ (4) · el-reloj-horas-y-media ✅ (4) · _siguiente_ **monedas-y-billetes** · _pendiente_ calendario.
