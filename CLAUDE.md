...
**Arrancar por:** ~~`numeros`~~ ✅ → ~~`sumas-con-llevada`~~ ✅ (4) → ~~`restas-con-llevada`~~ ✅ (4) → ~~`sumas-y-restas-mezcladas`~~ ✅ (4) → ~~`multiplicacion-concepto`~~ ✅ (6) → **SIGUIENTE: `tablas-de-multiplicar`** (decisión pendiente: ¿solo 2/5/10 o también 3/4? Preguntar a Miguel) → `doble-y-mitad`.
